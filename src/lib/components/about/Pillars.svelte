<script lang="ts">
    ...
    const pillars = [
        {
            title: "Masalah = Peluang",
            desc: "Kita suka banget dengerin curhatan masalah. Bukan dipake buat ngegosip, tapi buat cari gimana caranya bisa jadi solusi digital yang ciamik.",
            icon: `<svg class="text-5xl text-[#CCFF00] mb-6 group-hover:scale-110 transition-transform duration-300" fill="currentColor" height="1em" stroke="currentColor" stroke-width="0" viewBox="0 0 320 512" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M296 160H180.6l42.6-129.8C227.2 15 215.7 0 200 0H56C44 0 33.8 8.9 32.2 20.8l-32 240C-1.7 275.2 9.5 288 24 288h118.7L96.6 482.5c-3.6 15.2 8 29.5 23.3 29.5 8.4 0 16.4-4.4 20.8-12l176-304c9.3-15.9-2.2-36-20.7-36z"></path></svg>`
        },
        {
            title: "User Tuh Bestie",
            desc: "Kita ngga asal bikin app doang, tapi kita bikin buat dipake ama banyak orang. Jadi wajib hukumnya buat kita dengerin feedback dari user kek dengerin bestie sendiri, nah dari situ kita sesuaiin biar produknya nyaman dipake.",
            ...
            desc: "Ngga ada jagoan di sini. Kita percaya kolaborasi tim yang baik bakal bikin vibes kita ngebikin produk makin asik dengan result yang bikin lu bilang ''bjirr ni app keren banget''.",
...
<section class="py-32 bg-dark-bg" id="services" bind:this={sectionRef}>
    <div class="container">
        <div class="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
                <span class="inline-block px-4 py-1.5 border border-white/10 bg-white/5 text-white/80 text-xs font-mono uppercase tracking-wider mb-4">DNA KITA</span>
                <h2 class="text-4xl md:text-5xl font-black">Pilar-Pilar Kami</h2>
            </div>
            <p class="text-white/60 text-lg max-w-md md:text-right font-medium">
                Ini nih yang bikin kita tetep waras dan ngga asal bikin app doang.
            </p>
        </div>
