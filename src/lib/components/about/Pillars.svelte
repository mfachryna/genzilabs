<script lang="ts">
    ...
    const pillars = [
        ...
        },
        {
            ...
            desc: "Kita ga bikin produk buat robot, kita bikin buat dipake orang banyak. Kita dengerin feedback dari user kek dengerin bestie sendiri, dari situ kita sesuaiin biar produknya nyaman dipake.",
            ...
            desc: "Ngga ada jagoan di sini. Kita percaya kolaborasi tim yang baik bakal bikin vibes kita ngebikin produk makin asik dengan result yang keren.",
