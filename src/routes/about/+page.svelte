<script>
    ...
    import Quote from '$lib/components/about/Quote.svelte';
    import Pillars from '$lib/components/about/Pillars.svelte';
    import Background from '$lib/components/about/Background.svelte';
</script>
